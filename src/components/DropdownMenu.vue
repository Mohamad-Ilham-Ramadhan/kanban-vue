...
<template>
  <div
    v-show="props.open"
    :class="['absolute z-[1000] w-[196px] px-6 py-4 rounded-lg font-semibold bg-white dark:bg-dark shadow-md shadow-slate-200 dark:shadow-zinc-900', props.top ? props.top : 'top-[130%]', props.left, props.right, props.bottom]"
  >
    <div
