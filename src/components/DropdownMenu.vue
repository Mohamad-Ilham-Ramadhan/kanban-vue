...
<template>
  <div
    v-show="props.open"
    :class="['absolute z-[1000] w-[196px] px-6 py-4 rounded-lg font-semibold bg-dark drop-shadow-md', props.top ? props.top : 'top-[130%]', props.left, props.right, props.bottom]"
  >
    <div
